...
data:
  ...
  SQL_DATABASE: trackmilesdb
  SQL_USER: postgres
  SQL_PASSWORD: postgres
  SQL_HOST: database-postgresql.default.svc.cluster.local
  SQL_PORT: '5432'
  DJANGO_ALLOWED_HOSTS: localhost;127.0.0.1;server;localhost;backend-trackmiles.ovh001.eynes.com.ar;[::1];milleros.com.ar;api.milleros.com.ar
  DJANGO_CORS_ALLOWED_ORIGINS: https://milleros.com.ar
  DJANGO_SECRET_KEY: foo
  DJANGO_CSRF_TRUSTED_ORIGINS: https://api.milleros.com.ar;https://milleros.com.ar
...
spec:
  ...
  tls:
  - hosts:
    - flower.milleros.com.ar
    secretName: milleros-server-flower-production-tls
  rules:
  - host: flower.milleros.com.ar
    http:
      paths:
      - path: /
        pathType: Prefix
